...
btns.forEach(btn => btn.addEventListener("click", (event) => clickHandler(event)));
...
function showCategory(category) {
    ...
    switch(category) {
        case 'phones':
            s=getProductMarkup(products.phones);
            break;
        case 'tablets':
            s=getProductMarkup(products.tablets);
            break;
        case 'tv':
            s=getProductMarkup(products.tv);
            break;
    }
    prod.insertAdjacentHTML('beforeend', s);
}
