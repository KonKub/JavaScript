...
btns.forEach(btn => btn.addEventListener("click",(event) => handleClick(event)));
...
function handleClick(clickedButtonEvent) {
    ...
    let btnText=cardNode.querySelector('button').textContent;
...
function showMoreText(card) {
    ...
    var someText="Произвольный текст";
